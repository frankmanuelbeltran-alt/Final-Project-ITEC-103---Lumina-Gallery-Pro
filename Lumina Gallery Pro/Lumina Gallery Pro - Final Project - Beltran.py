...
class LuminaGalleryProMax:
    ...
    def create_sidebar(self):
        self.sidebar = tk.Frame(self.main_container, width=280, bg=self.colors['surface'])
    ...
    def show_preferences(self):
        ...
        def save_prefs():
            ...
            Config.THUMB_SIZE = size_var.get()
        ...
        tk.Button(dialog, text="Save", command=save_prefs,
                 bg=self.colors['accent'], fg='white', font=self.font_bold,
