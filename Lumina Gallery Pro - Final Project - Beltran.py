...
class LuminaGalleryProMax:
    ...
    def show_empty_gallery(self):
        self.empty_frame = tk.Frame(self.grid_canvas, bg=self.colors['bg'])
    ...
    def update_visible_thumbnails(self):
        ...
        buffer_start = max(0, start - self.columns * 2)
        buffer_end = min(len(self.media), end + self.columns * 2)
